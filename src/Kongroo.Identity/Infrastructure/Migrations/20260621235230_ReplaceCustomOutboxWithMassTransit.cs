...
namespace Kongroo.Identity.Infrastructure.Migrations
{
    ...
    public partial class ReplaceCustomOutboxWithMassTransit : Migration
    {
        ...
        {
            migrationBuilder.DropTable(name: "outbox_message", schema: "identity");

            migrationBuilder.DropTable(name: "inbox_state", schema: "identity");

            migrationBuilder.DropTable(name: "outbox_state", schema: "identity");
